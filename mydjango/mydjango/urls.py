...
urlpatterns = [
    ...
    path('termnco/', views.TermncoView.as_view(), name="termnco-page"),
    #path('privacy/', views.privacy, name="privacy-page"),
    path('privacy/', views.PrivacyView.as_view(), name="privacy-page"),
    #path('blog/', views.blog, name="blog-list-page"),
    path('blog/', views.BlogListView.as_view(), name="blog-list-page"),
    #path('blog/<id>/', views.blog_detail, name="blog-detail-page"),
    path('blog/<slug>/', views.blog_detail, name="blog-detail-page"),
